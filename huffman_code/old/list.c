...
void **list_get(register list *lst, register int index)
{
	list	node = *lst;
...
__always_inline __nonnull ((1))
static inline void *list_insert_after_node(list node, const void *value)
{
	list	new_node;
...
void list_insert_pos(list *lst, size_t pos, const void *value)
{
...
void list_insert_front(list *lst, const void *value)
{
	list	new_node;
...
void list_insert_back(list *lst, const void *value)
{
	list	node = *lst;
...
void list_insert_sorted(list *lst, const void *value)
{
	list	node = *lst;
