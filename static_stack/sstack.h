...
void sstack_init(sstack *st, const int size) __nonnull ((1));
void sstack_free(sstack *st) __nonnull ((1));

void sstack_test(sstack *st) __nonnull ((1));
...
void sstack_push(sstack *st, const int data) __nonnull ((1));
int sstack_pop(sstack *st) __nonnull ((1));
